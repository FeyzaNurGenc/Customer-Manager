...
namespace Customer_manager.Controllers
{
    public class OzgecmisController:Controller
    {
        ...
        private readonly GenericRepository<Ozgecmis> _repository;
        private readonly ApplicationDbContext _context;

        public OzgecmisController(GenericRepository<Ozgecmis> repository, UserManager<Customers> userManager, ApplicationDbContext context)
        {
        ...
        {
            var model = new Ozgecmis();
            return View(model);
        }

        [HttpPost]
        public IActionResult Create(Ozgecmis entity)
        {
        ...
        [HttpPost]
        public ActionResult Edit(Ozgecmis entity)
        {
            if (ModelState.IsValid)
            {
